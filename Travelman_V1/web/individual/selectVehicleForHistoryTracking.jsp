<%-- 
    Document   : selectVehicleForHistoryTracking
    Created on : Aug 5, 2011, 1:23:29 PM
    Author     : Techno Life
--%>
	...
	<body id="homepage">
		...
		<div id="rightside">
			...
			<div class="contentbox">
                    <form action="historyTracking">
                        <table cellpadding="0" cellspacing="0" border="2" width="100%">                       
                                <s:select label="Vehicle Id" name="vregisteration_num" list="list"></s:select>
       ...
       <div id="leftside">
            ...
            <ul id="nav">
                ...
                <li>
                    <a class="expanded heading">Administrative</a>
                    <ul class="navigation">                      
