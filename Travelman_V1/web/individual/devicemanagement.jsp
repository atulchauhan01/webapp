...
<title>TechnoLife : Device Management</title>
...
<body id="homepage">
    ...
    <div id="rightside">
         ...
         <div class="contentcontainer">
            ...
            --><div class="contentbox">
            	<table width="100%">
                	...
                	<thead>
                    	<tr>
                        	   <th><a href="listDeviceAction" title="" class="likelogin"> List All Device </a></th>
                        </tr>
                    </thead>
                    <tbody>
                    	<tr>
                        	  <th> <a href="addDevProfileAction" title="" class="likelogin">Create New Device </a></th>
                        </tr>
                        <tr>
                        	
                            <th> Create Device Profile </th>
                        </tr>
                        <tr>
                        	 <th> Edit Device profile </th>
                        </tr>
                    </tbody>
                </table>
        ...
        <div id="footer">
        	&copy; Copyright 2011, Techno Life Pvt. Ltd. All Rights Reserved.
        </div> 
