        ...
        <script type="text/javascript"> 
            ...
            function setContent()
            {
                ...
                for (i = 0; i < latArray.length; i++) {
                    ...
                    dummy="dummy"+i;
                  //  alert(dummy);
                   // alert("content array value-->"+contentArray[i]);
                ...
                <div class="contentbox">
                    ...
                    <table cellpadding="0" cellspacing="0" border="2" width="100%">
                        ...
                        <s:iterator value="list" status="dummy" >
                            ...
                            <td><input type="text" readonly="readonly" width="50" boder="0" id="dummy<s:property value="%{#dummy.index}"/>" value="" style="width: 300px;border-color: transparent"/>
                              </td> 
                            <td><s:property value="startDate" /></td>
                            <td><s:property value="speed" /></td>                        
                            <td><s:property value="ignition" /></td>
                            <td><s:property value="GPS" /></td>
                            </tr>
                        </s:iterator>
                    </table>
