                    ...
                    <form action="listHistoryReport">
                        <table cellpadding="0" cellspacing="0" border="1" width="100%">
                            <s:select label="Vehicle Id" name="vregistration_num" list="list"></s:select>
                                <td>Start Date</td><td><input type="text" name="startDate" id="demo1" maxlength="25" size="25" readonly="true" /><a href="javascript:NewCal('demo1','ddmmmyyyy',true,24)"><img src="img/cal.gif" width="16" height="16" border="2" alt="Pick a date"/></a></td>                           
