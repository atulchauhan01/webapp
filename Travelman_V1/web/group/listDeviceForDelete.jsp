...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title>List Delete Device</title>
            ...
            <!-- Alternative Content Box Start -->
              <div class="contentcontainer">
                ...
                <div class="contentbox">
                    ...
                    <table width="100%">
                        <s:form action="detailDeleteDevice" method="post" validate="true">


                            <tr>
                                <s:select label="Device ID" name="deviceId" list="list" /><font style="color: red"><s:property value="#request.error"/></font>	
                            </tr>
