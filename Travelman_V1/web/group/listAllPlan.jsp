        ...
        <div id="rightside">
            ...
            <div class="contentcontainer">
                ...
                <div class="contentbox">
                    <table width="100%">
                        <tr>
                            <td><a href="createPlans" title="" class="likelogin">Create New Plan </a></td>
                            <td><a href="listPlan" title="" class="likelogin"> List All Plan </a></td>
                    ...
                    <s:iterator value="list" var="Plan">
                        <tr>
                            <td width="50"><s:property value="planname"/></td>
                            <td width="50"><s:property value="rental"/></td>
                            <td width="50"><s:property value="billingcycle"/></td>
                            <td width="50"><s:property value="facilities"/></td>
                            <td width="100"><s:property value="assignto"/></td>
                    ...
                    <display:table id="data" name="list" requestURI="/listPlan" pagesize="20" export="true">
                        <display:column property="planname" title="Plan Name" sortable="true" media="html" group="1" />
                        <display:column property="rental" title="Rental" sortable="true" />
                        <display:column property="billingcycle" title="Billing Cycle" sortable="true" />
                        <display:column property="facilities" title="Facilities" sortable="true" />
                        <display:column property="assignto" title="Assign To" sortable="true" />
