        ...
        <div id="rightside">
            ...
            <div class="contentcontainer">
                ...
                <div class="contentbox">
                    <table width="100%" cellpadding="20" border="2">
                        <s:form action="addDeviceProfileAction" method="post" validate="true">
                            <thead>
                                <tr>
                                    <td width="200"><a href="addDevProfileAction" title="" class="likelogin">Create New Device </a></td>
                                    <td width="200"><a href="listDeviceAction" title="" class="likelogin"> List All Device </a></td>
                                    <td width="200"><a href="editMgtDevice" title="" class="likelogin">Edit Device </a></td>
                                    <td width="200"><a href="listDeleteDevice" title="" class="likelogin">Delete Device </a></td>
                                </tr>

                            </thead>
                            <tbody>
                                <tr>                          
                                    <s:select list="list" name="userid" label="User ID "></s:select>
                                    <s:textfield label="Device ID " name="deviceid"></s:textfield>
                                    <s:textfield label="Device Type " name="dtype"></s:textfield>
                                </tr>
                                <tr>
                                <s:textfield label="Device EMI " name="diemi"></s:textfield>
                                <s:textfield label="device Sim Number" name="dsim_num"></s:textfield>
                                </tr>
                            </tbody>
                            <s:submit value="install device"></s:submit>
                        </s:form>
                    </table>
