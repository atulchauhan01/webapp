        ...
        <div id="rightside">
            ...
            <div class="contentcontainer">
                ...
                <div class="contentbox">
                    <table width="100%">
                        <s:form action="sendSmsAction" method="post" >
                            <thead>
                                <tr>
                                    <th width="5%">
                                        &nbsp;
                                    ...
                                    <th width="15%">
                                        ...
                                        <s:textfield label="Mobile Number " name="mobileno"></s:textfield>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th width="5%">
                                    ...
                                    <s:select name="time" label="Time Duration :" headerKey="0" headerValue="Select Time" list=" # {'30 min':'30 min','1 Hour':'1 Hour','2 Hours':'2 Hours','3 Hours':'3 Hours',
									'5 Hours':'5 Hours','10 Hours':'10 Hours','12 Hours':'12 Hours','24 Hours':'24 Hours' }"/>
