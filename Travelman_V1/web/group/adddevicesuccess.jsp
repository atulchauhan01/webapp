    ...
    <body id="homepage">
                ...
                <div class="contentbox">
                    <table width="100%">
                        <s:form action="addDeviceProfileAction" method="post">
                            <thead>
                                <tr>
                                    Thanks for submitting device details
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
        ...
        <div id="leftside">
            ...
            <ul id="nav">
                ...
                --><li><a class="expanded heading">Admin</a>
                     <ul class="navigation">
                ...
                <li><a class="expanded heading">Report</a>
                    <ul class="navigation">
                        <li><a href="#" title="" class="likelogin">Under Construction</a></li>
                        <li><a href="#" title="">Under Construction</a></li>
                        <li><a href="#" title="">Under Construction</a></li>
                    </ul>
                </li>  
