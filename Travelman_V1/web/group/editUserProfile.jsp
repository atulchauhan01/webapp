        ...
        <div id="rightside">
            ...
            <div class="contentcontainer">
                ...
                <div class="contentbox">
                    <table width="100%">
                        <s:form action="saveEditUser" method="post">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr> <td >User Id:</td><td><input type="text" name="userId" value="<s:property value="user.userId"/>" readonly="true"/></td></tr>  

                                <tr> <td >First Name:</td><td><input type="text" name="fname" value="<s:property value="user.fname"/>" /></td></tr>

                                <tr> <td> Last Name:</td><td><input type="text" name="lname" value="<s:property value="user.lname"/>" /></td></tr>

                                <tr><td> Email:</td><td><input type="text" name="uemail" value="<s:property value="user.uemail"/>" /></td></tr>

                                <tr><td>Password:</td><td><input type="password" name="password" value="<s:property value="user.password"/>" /></td></tr>

                                <tr><td>Business Address</td><td><input type="text" name="baddress" value="<s:property value="user.baddress"/>" /></td></tr>

                                <tr><td>Home Address</td><td><input type="text" name="haddress" value="<s:property value="user.haddress"/>" /></td></tr>

                                <tr><td>User Type  </td><td><input type="text" name="utype" value="<s:property value="user.utype"/>"  /></td><td>(Group/Individual)</td></tr>

                                <tr><td>Mobile Number </td><td> <input type="text" name="umobile" value="<s:property value="user.umobile"/>" /></td></tr> 
                                <tr>
                                    <td>Select Status</td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <%-- <s:radio list="#{'1':'Active','2':'Deactive'}" name="active" label="Select Status"></s:radio>--%>
                                    </td>
                                </tr>
