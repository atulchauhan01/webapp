        ...
        <div id="rightside">
            ...
            <div class="contentcontainer">
                ...
                <div class="contentbox">
                    <table width="100%">
                        <s:form action="giveFeedbackAction" method="post" >
                            <thead>
                                <tr>
                                    <th width="5%">
                                        &nbsp;
                                    ...
                                    <th width="15%">
                                        ...
                                        <s:select name="subject" label="Subject :" headerKey="0" headerValue="Select Subject" list=" # {'Suggestion':'Suggestion','Complain':'Complain'}"/>
                                ...
                                <tr>
                                    ...
                                    <th width="16%"><s:textarea label="Body" name="body" cols="70" rows="10"/>
