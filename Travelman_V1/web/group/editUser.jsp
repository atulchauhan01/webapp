        ...
        <div id="rightside">
			...
			Select User Id...
                ...
                <div class="contentbox">
                    <table width="100%">
                        <s:form action="editUserProfile" method="post">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>					
                                        ...
                                        <s:select name="uemail" label="Select User Id :" headerKey="0" headerValue="Select User Id" list="list" />	
