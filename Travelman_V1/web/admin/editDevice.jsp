<%-- 
    Document   : editDevice
    Created on : Aug 11, 2011, 12:43:52 AM
    Author     : techno life
--%>
			...
			<div class="contentcontainer">
				...
				<div class="contentbox">
                        ...
                        <s:form action="editDevice" method="post">
                            ...
                            <tbody>
                                <tr><s:textfield type="text" name="userid" label=" User ID"/></tr>  
                                
                                <tr><s:textfield type="text" name="deviceid" disabled="disabled" label="Device ID"/></tr>

                                <tr><s:textfield type="text" name="dtype" label="Device Type"/></tr>

                                <tr><s:textfield type="text" name="diemi" label="Device IEMI"/></tr>

                                <tr><s:textfield type="text" name="dsim_num" label="Device Sim Number"/></td></tr>
