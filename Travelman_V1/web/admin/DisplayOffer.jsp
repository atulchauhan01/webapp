        ...
        <div id="rightside">
            ...
            <div class="contentcontainer">
                ...
                <div class="contentbox">
                    ...
                    <s:iterator value="list" var="offer">
                        <tr>
                            <td width="50"><s:property value="offerName"/></td>
                            <td width="50"><s:property value="offerAmount"/></td>
                    ...
                    <display:table id="data" name="list" requestURI="/offerDisplayAction" pagesize="20">
                        <display:column property="offerName" title="Offer Name" sortable="true" media="html" group="1" />
                        <display:column property="offerAmount" title="Offer Amount" sortable="true" />
