        ...
        <div id="rightside">
            ...
            <div class="contentcontainer">
                ...
                <div class="contentbox divheight">
                    <form action="listOverSpeedReport">
                        <table cellpadding="0" cellspacing="0" border="1" width="100%">
                            <s:select label="Vehicle Id" name="vregistration_num" list="list"></s:select>
                            <tr> <td>Start Date</td><td><input type="text" name="startDate" id="demo1" maxlength="25" size="25" readonly="true" /><a href="javascript:NewCal('demo1','ddmmmyyyy',true,24)"><img src="img/cal.gif" width="16" height="16" border="0" alt="Pick a date"/></a></td></tr>                           

                            <tr><td>End Date</td><td><input type="text" name="endDate" id="demo2" maxlength="25" size="25" readonly="true" /><a href="javascript:NewCal('demo2','ddmmmyyyy',true,24)"><img src="img/cal.gif" width="16" height="16" border="0" alt="Pick a date"/></a></td></tr>
                            <!--                             <tr><td>Slect Over Speed Limit</td><td><></td></tr>-->
                            <s:select name="overSpeed" label="Slect Over Speed Limit" list="{30,40,50,60,70,80}" />
                        </table>
