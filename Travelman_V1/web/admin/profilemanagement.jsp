...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title>Techno Life: Fleet Management System</title>
            ...
            <div class="contentcontainer">
                ...
                --><div class="contentbox">
                    <table width="100%">
                        ...
                        <thead>
                            <tr>
                                <th><a href="listProfileAction" title="" class="likelogin"> List All Profile </a></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <th> <a href="createProfileAction" title="" class="likelogin">Create New Profile </a></th>
                            </tr>
            ...
            <ul id="nav">
                <li>
                    <ul class="navigation">
                        ...
                        <li>
                            <a href="<s:url action="liveTracking"/>" title="">Home</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a class="expanded heading">Notification</a>
                    <ul class="navigation">
                ...
                <li>
                    ...
                    <ul class="navigation">
                        <li>
                            <a href="#" title="" class="likelogin">Under Construction</a>
                        </li>
                        <li>
                            <a href="#" title="">Under Construction</a>
                        </li>
                        <li>
                            <a href="#" title="">Under Construction</a>
                        </li>
