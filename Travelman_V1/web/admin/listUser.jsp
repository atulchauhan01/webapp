                ...
                <div class="contentbox">
                    ...
                    <s:iterator value="list" var="user">
                        <tr>
                            ...
                            <td width="50"><s:property value="active"/></td>

                        </tr></s:iterator>
                    
                    </table>-->

                    <display:table id="data" name="list" requestURI="/listUser" pagesize="6" export="true">
                        <display:column property="userId" title="User Id" sortable="true"  group="1" />
                        ...
                        <display:column property="active" title="Status" sortable="true" />
