...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title>Add vehicle to Existing Device</title>
        ...
        <div id="rightside">
            ...
            <div class="contentcontainer">
                ...
                <div class="contentbox">
                    <table width="100%">
                        <s:form action="addExistingVehicle" method="post" validate="true">
                            <thead>
                                <tr>
                                    <th width="5%">
                                        &nbsp;
                                    ...
                                    <th width="15%">
                                        <s:select label="User Id" name="userid" list="list_userid" />	
                                        <s:select label="Vehicle Id" name="vehicleid" list="list_vehicleid" />
