        ...
        <!-- Alternative Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Vehicles Current Status</h2>
            </div>
            <!--<div class="contentbox">
					<table width="100%">
						<s:form action="addDeviceProfileAction" method="post">
							<thead>
								<tr>
									<th >
								...
								<s:submit value="List Of All Device"  />
            ...
            --><div class="contentbox">
            	<table width="100%">
                	...
                	<thead>
                    	<tr>
                        	   <th><s:a href="addNewVehicle" title="" class="likelogin">Add New Vehicle to device</s:a></th>
                        </tr>
                    </thead>
                    <tbody>
                    	<tr>
                        	  <th> <a href="listVehicle" title="" class="likelogin">Vehicle List</a></th>
                        </tr>
                        
                        <tr>
                        	  <th> <a href="addExVehicle" title="" class="likelogin">Add Existing Vehicle to user</a></th>
                        </tr>
                        
                        <tr>
                        	  <th> <a href="editVehicleList" title="" class="likelogin">Edit Vehicle</a></th>
                        </tr>
                        
                        <tr>
                        	  <th> <a href="deleteVehicleList" title="" class="likelogin">Delete Vehicle</a></th>
                        </tr>
                    </tbody>
                </table>
