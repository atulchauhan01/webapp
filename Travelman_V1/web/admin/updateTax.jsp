			...
			<div class="contentcontainer">
				...
				Define Tax
                        ...
                        <s:form action="save" method="post">
                            ...
                            <tbody>
                                <s:iterator value="list" var="Tax">
                        
                            
                            <tr> <td >Service Tax:</td><td><input type="text" name="serviceTax" value="<s:property value="serviceTax"/>"/></td></tr>  
                                
                               
                                <tr> <td> Education Cess:</td><td><input type="text" name="educationCess" value="<s:property value="educationCess"/>" /></td></tr>

                                <tr><td> S H Edu Cess:</td><td><input type="text" name="sheCess" value="<s:property value="sheCess"/>" /></td></tr>

                                <tr><td>Other Tax:</td><td><input type="text" name="otherTax" value="<s:property value="otherTax"/>" /></td></tr>

                                                      
                               <s:submit value="Update Tax" ></s:submit>
                                </s:iterator>
                            </tbody>
                        </s:form>
                    </table>
