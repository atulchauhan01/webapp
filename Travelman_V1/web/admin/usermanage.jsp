    ...
    <body id="homepage">
                    ...
                    <!--<table width="100%">
                            ...
                            <tbody>
                                    <tr>
                                            ...
                                            <td>
                                                    <a href="#" title=""><img src="img/icons/icon_delete.png"
                                                                    alt="Inactive" />
                                                    </a>
                                            </td>
                                            <td>
                                                    <a href="#" title=""><img src="img/google_maps.png"
                                                                    alt="Google Map" />
                                                    </a>
                                            </td>
                                            <td>
                                                    <a href="#" title=""><img src="img/yahoo_map.png"
                                                                    alt="Yahoo Map" />
                                                    </a>
                                            </td>
                                            <td>
        ...
        <div id="leftside">
            ...
            <ul id="nav">
                ...
                <li>
                    <a class="collapsed heading">Notification</a>
                    <ul class="navigation">
                ...
                <li>
                    <a class="collapsed heading">Report</a>
                    <ul class="navigation">
                        <li>
