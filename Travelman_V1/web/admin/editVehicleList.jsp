        ...
        <div id="rightside">
            ...
            <div class="contentcontainer">
                ...
                <div class="contentbox">
                    ...
                    <table width="100%">
                        <s:form action="editVehicleData" method="post" validate="true">
                            <tbody>
                                <tr>
                                    <s:select name="vehicleId" label="Select Vehicle Id :"  list="list_vehicleid" />	
                                </tr>
                                <tr><s:submit value="Edit Vehicle" ></s:submit></tr>
                                </tbody>
                        </s:form>
                    </table>
